  ...
  <div class="row">
   <div class="col-xs-12">
     <div class="products_container_top">
       <p class="products_container_title">Менеджери</p>
       <div class="product_container_buttons">
                  <a href="<?= $this->Url->build(['controller' => 'managers','action'=>'add']) ?>" class="product_container_buttons_add btn-primary">
                  ...
                  <tr>
                    ...
                    <td class='table__flex'>
                      <?php
                        ...
                        echo  $this->Form->postLink('<i class="fa fa-trash"></i>', ['action' => 'delete', $user->id], ['class'=>'btn  delete__user','escape' => false,'confirm' => __('Ви справді хочете видалити Користувача {0} ?', $user['firstname'])]);  ?>
                    </td>
                    </tr>
                <?php endforeach; ?>
              </tbody>
