    ...
    <div class="flipper">      
      <div class="login-panel" style="<?= $is_forgot ? 'display: none;' : '' ?>">
        ...
        <?php echo $this->Form->create(); ?>
          ...
          <div class="form-group has-feedback">
            <input type="password" name="confirm__password" class="form-control" placeholder="Password">
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
          </div>
          <div class="row">
            ...
            <!-- /.col -->
            <div class="col-xs-4">
              <button type="submit" class="btn btn-primary btn-block btn-flat">Save data</button>
            </div>
            <!-- /.col -->
          </div>
