...
<?php   endif; ?>
<?=  $this->Form->control('file',array('type'=>'file','accept'=>'image/jpeg,image/png','id'=>'video-files','label' => 'Choose file','class'=>'form-control','required'=>'required')); ?>
...
<?=  $this->Form->control('tags._ids', ['options' => $tags,'label' => 'Tags','class'=>'form-control','required'=>'required']); ?>
<?=  $this->Form->submit('Upload picture',['class'=>'btn  btn-primary save__changes__form']); ?>
<?=   $this->Form->end() ?>
