...
<script src="https://cdn.jsdelivr.net/npm/select2@4.0.13/dist/js/select2.min.js"></script>
 ...
 <section class="content white_background products_container">
  <div class="row">
   <div class="col-xs-12">
     <?= $this->Form->create($producersDiscount, ['type' => 'file'])  ?>
     <div class="products_container_top">
       <p class="products_container_title">Додавання виробника</p>
  ...
  <div class="playlist__managment--item__left">
    <p>Виберіть виробника зі списку</p>
  </div>
  <div class="playlist__managment--item__right">
    <div class="playlist--item--sub">
    <?=  $this->Form->control('producer_id',array('label' => 'Категорія','type'=>'select','min'=>0,'class'=>'form-control js-example-basic-single', 'options'=>$producer_id, 'required'=>'required','empty'=>'Виберіть виробника','id'=>'choose_category'));?>    
       ...
       <div class="playlist__managment--item">
  <div class="playlist__managment--item__left">
    <p>Виберіть коефіцієнт зміни (%)</p>
  </div>
  <div class="playlist__managment--item__right">
    <div class="playlist--item--sub">
    <?=  $this->Form->control('discount',array('label' => 'First Name','class'=>'form-control','required'=>'required', 'type' => 'number'));?>
