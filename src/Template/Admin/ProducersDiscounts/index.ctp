  ...
  <div class="row">
   <div class="col-xs-12">
     <div class="products_container_top">
       <p class="products_container_title">Зміни вартості виробників</p>
       <div class="product_container_buttons">
                  <a href="<?= $this->Url->build(['action'=>'add']) ?>" class="product_container_buttons_add btn-primary">
      ...
      <div class="box-body table-responsive no-padding">
       <div class="box-header">
              ...
              <table class="table table-bordered table-striped" id="example1">
                ...
                <tbody>
                <?php   foreach ($producersDiscounts as $producersDiscounts_item): ?>
                  <tr>
                    <td class="first-check"> <label class="custom-checkbox">
                          <input type="checkbox" id="delete-all" value="<?= $producersDiscounts_item->id ?>" class='delete_item'>
                          <span class="checkmark"></span>
                    </label></td>
                    <td><?= $producersDiscounts_item->id ?></td>
                    <td><?= $producersDiscounts_item->producer->name ?></td>
                    <td><?= $producersDiscounts_item->discount ?></td>
                    
                    <td class='table__flex'>
                      <?php
                        echo   $this->Html->link('<i class="fa fa-pencil"></i>', ['action' => 'edit', $producersDiscounts_item->id], ['class'=>'btn change__user','escape' => false]);
                        echo  $this->Form->postLink('<i class="fa fa-trash"></i>', ['action' => 'delete', $producersDiscounts_item->id], ['class'=>'btn  delete__user','escape' => false,'confirm' => __('Ви справді хочете видалити Знижку виробника # {0}?', $producersDiscounts_item->producer->name)]);  ?>
                    </td>
                    </tr>
                <?php endforeach; ?>
              </tbody>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="gallery-box form__inline" style="text-align: center;">
          <h2 style="text-align: center;">Ви хочете видалити знижки виробників ?</h2>
          <button class="close_modal_form close__modal" >Ні</button>
           <?= $this->Form->create('Delete',['url'   => array(
               'controller' => 'producers-discounts','action' => 'deletechecked'
           )])  ?>
