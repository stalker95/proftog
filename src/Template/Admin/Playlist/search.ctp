             ...
             ?>
              ...
              <table class="table table-bordered table-striped" id="example1">
                ...
                <?php   foreach ($playlists as $playlist) : ?>
                  ...
                  <?=
                   $this->Form->postLink('<i class="fa fa-trash"></i>', ['action' => 'delete', $playlist->id], ['class'=>'btn  delete__user','escape' => false,'confirm' => __('Are you sure you want to delete # {0}?', $playlist->name)]); 
                   ?>
                  </td>
                 </tr>
              <?php  endforeach;  ?>  
