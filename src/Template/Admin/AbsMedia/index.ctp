 <!-- Main content -->
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <h1 class="blog__title">ABS Media list</h1>
          <div class="box">
           ...
           <div class="box-header">
            <div class="create__new__user">
               ...
               'controller' => 'absmedia','action' => 'deletechecked'),'class'=>'delete_form_checked','style'=>'display:none;'])  ?>
     ...
     <?=   $this->Form->end() ?>
              ...
              <table class="table table-bordered table-striped" id="example1">
                ...
                <?php   foreach ($absMedia as $list) : ?>
                  <tr>
                  <td>
                  <img src="<?= $baseUrl.'uploads/files/'.$list->media['name']   ?>" alt="" style="width:100px;">
                    
                  </td>
                  <td><?= $list->media['file'];  ?></td>
                  <td><?= $list->media['created'];  ?></td>
                  <td><?= $list->media->Users['firstname'] ." ".$list->media->Users['lastname'];  ?></td>
                  <td><?= $list->media['type'];  ?></td>
                 <td class='table__flex'>

               <?php                    echo  $this->Form->postLink('<i class="fa fa-trash"></i>', ['action' => 'delete', $list->id], ['class'=>'btn  delete__user','escape' => false,'confirm' => __('Are you sure you want to delete media # {0}?', $list->id)]); ?>
                 </td>
                  </tr>
               <?php endforeach;  ?>
