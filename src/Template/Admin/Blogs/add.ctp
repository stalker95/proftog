  ...
  <div class="row">
   <div class="col-xs-12">
     ...
     <div class="products_container_top">
       <p class="products_container_title">Додавання блога</p>
            ...
            <div class="playlist__managment--item__right">
              <div class="playlist--item--sub">
				...
				<div class="playlist__managment--item">
  					...
  					<div class="playlist__managment--item__right">
    					<div class="playlist--item--sub">
      						<?=  $this->Form->control('image',array('label' => 'First Name','type'=>'file','class'=>'input-file-trigger form-control upload_gallery_item input-file-trigger','required'=>'required','style'=>'font-size: 1em;padding:0px;width:200px;','id'=>'fileimgMeal'));?>    
    					
    					
              </div>
              <div id="fotosViewMeal" class="image_gallery_preview" style="position: relative;"></div>
  					</div>
				</div>
				<div class="playlist__managment--item">
  					<div class="playlist__managment--item__left">
