              ...
              <table class="table table-bordered table-striped" id="example1">
                ...
                <tr>
                 <td><input type='checkbox' value="<?= $user->id ?>" class='delete_item'></td>
                  ...
                  <td><?= $user->program['title'] ?></td>
                  <td class='table__flex'>
                 <?php  
                 echo $this->Html->link('<i class="fa fa-pencil"></i>', ['action' => 'edit', $user->id], ['class'=>'btn  change__user','escape' => false]);  
                  echo   $this->Form->postLink('<i class="fa fa-trash"></i>', ['action' => 'delete', $user->id], ['class'=>'btn  delete__user','escape' => false,'confirm' => __('Are you sure you want to delete # '.$user->firstname ." ". $user->lastname.' ', $user->id)]); 
                    ?>
                  </td>
                 </tr>
              <?php  endforeach; ?>
