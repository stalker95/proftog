    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <h1 class="blog__title">Contact form </h1>
          <div class="box">
    ...
    padding: 6px 30px;"  data-toggle="modal" data-target="#mediaGallery" >
              ...
              <table class="table table-bordered table-striped" id="example1">
                ...
                <?php   foreach ($contactForm as $contactForm_item) {
                  echo "<tr>
                  <td><input type='checkbox' value=".$contactForm_item->id." class='delete_item'></td>
                  <td>".$contactForm_item->id."</td>
                  <td>".$contactForm_item->name."</td>
                  <td>".$contactForm_item->email."</td>
                  <td>".$contactForm_item->message."</td>
                  
                 <td class='table__flex'>";
                 echo   $this->Html->link('<i class="fa fa-pencil"></i>', ['action' => 'view', $contactForm_item->id], ['class'=>'btn change__user','escape' => false]);
                 echo  $this->Form->postLink('<i class="fa fa-trash"></i>', ['action' => 'delete', $contactForm_item->id], ['class'=>'btn  delete__user','escape' => false,'confirm' => __('Are you want  to delete # {0}?', $contactForm_item->name)]);  
                  echo "</td>";
                  echo "</tr>";
                } ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="gallery-box form__inline" style="text-align: center;">
          <h2 style="text-align: center;">Do you want to delete Contact data ?</h2>
          
                   <button class="close_modal_form close__modal" >No</button>
                   <?= $this->Form->create('Delete',['url'   => array(
               'controller' => 'contactForm','action' => 'deletechecked'
           )])  ?>
