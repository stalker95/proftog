     ...
     <div class="container">
       <div class="row">
         <h3 class="box-title"><?= __('Theme and marquee editor') ?></h3>
       </div>
     </div>
<div class="playlist__managment">
  ...
  <div class="playlist__managment--item__right">
    <div class="playlist--item--sub">
            <?=  $this->Form->control('videos',array('label' => false,'class'=>'form-control','min'=>6));?>
...
<?=  $this->Form->submit('Save ',['class'=>'btn  btn-primary save__changes__form__playlist']); ?>
  ...
  <?php   debug($playlist[0]->themes); ?>
  <div class="playlist__managment--item__right">
    <div class="playlist--item--sub">
      <?=  $this->Form->control('themes',array('label' => false,'class'=>'form-control','min'=>6));?>
    </div>
  </div>
</div>
...
<div class="play__list__static__preview">
     ...
     <img src="/<?=  $file ?>" alt="" class="play__list__static__preview__main">
...
function load_media() {
      ...
      box.pagination({
          ...
          showNavigator: true,
          formatNavigator: '<button  id="btn-add-media-to-playlist" disabled  class="ajax-insert"><?= __('Add') ?></button>',
          pageSize: 5,
            ...
            if (data.length > 0) {
              for (var i=0; i<data.length; i++) {
                html += '<tr>' +
                          ...
                          '</td>' +
                          '<td><img class="media-preview" src="'+baseUrl+data[i].file+'"/></td>' +
