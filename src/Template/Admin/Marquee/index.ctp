    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
             <h1 class="blog__title"><?=   __('Marquee editor'); ?></h1>
          <div class="box">
...
<?php foreach ($marques as $marque): ?>
       <?= $this->Form->create($marque,['url'   => array(
               'controller' => 'marquee','action' => 'edit'
           ), 'type' => 'file'])  ?>

       <div class="marque__box">
          <p>:Current logo </p>
          <?php echo $this->Html->image("/uploads/logo/".$marque['logo'], ['label'=>'true','style'=>'width:100px;height:100px;display:block;object-fit:cover;', 'alt' => __('User Image')]); ?> 
          <br>
          ...
          <div class="marquee_checkbox">
          <?= $this->Form->control('logo_display', ['type' => 'checkbox',  'label' => "diplay logo", 'required' => false, 'div' => false, 'style' => '']); ?>
          </div>
          <?=  $this->Form->textarea('text',array('label' => false,'class'=>'form-control','min'=>6));?>
         
          <div class="marquee_checkbox">
           <?= $this->Form->control('marque_display', ['type' => 'checkbox',  'label' => "diplay text "]); ?>
          </div>
