                  ...
                  <tr>
                    ...
                    <td class='table__flex'>
                      <?php
                        ...
                        echo  $this->Form->postLink('<i class="fa fa-trash"></i>', ['action' => 'delete', $attribute->id], ['class'=>'btn  delete__user','escape' => false,'confirm' => __('Ви справді хочете видалити атрибут {0} ? ', $attribute->name)]);  ?>
                    </td>
                    </tr>
                <?php endforeach; ?>
              </tbody>
