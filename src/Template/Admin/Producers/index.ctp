 <section class="content">
  <div class="row">
   <div class="col-xs-12">
     <h1 class="blog__title">Виробники</h1>
     <div class="box">
                  ...
                  <tr>
                    ...
                    <td class='table__flex'>
                      <?php
                        ...
                        echo  $this->Form->postLink('<i class="fa fa-trash"></i>', ['action' => 'delete', $producer->id], ['class'=>'btn  delete__user','escape' => false,'confirm' => __('Ви справді хочете видалити виробника # {0}?', $producer->id)]);  ?>
                    </td>
                    </tr>
                <?php endforeach; ?>
              </tbody>
