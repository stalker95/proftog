...
<script src="https://cdn.jsdelivr.net/npm/select2@4.0.13/dist/js/select2.min.js"></script>
    ...
    <div class="row">
      <div class="col-md-12">
        <h1 class="blog__title">Додавання виробника</h1>
  ...
  <div class="playlist__managment--item__right">
    <div class="playlist--item--sub">
    <?=  $this->Form->control('title_h1',array('label' => 'First Name','type'=>'text','class'=>'form-control','required'=>'required'));?>
  ...
  <div class="playlist__managment--item__right">
    <div class="playlist--item--sub">
    <?=  $this->Form->control('description_page',array('label' => 'First Name','type'=>'textarea','class'=>'form-control','required'=>'required'));?>
            ...
            <div class="playlist__managment--item__right">
              <div class="playlist--item--sub" style="display: block;">
                  ...
                  <div id="fotosViewMeal" style="position: relative;width: 100%;" class="image_gallery_preview">
                    <img src="<?= $this->Url->build('/producers/'.$producer->image, ['fullBase' => true]) ?>" alt="">
                  </div>  
                  </div>
            </div>
        </div>
<?=  $this->Form->submit('Збегегти',['class'=>'btn  btn-primary save__changes__form']); ?>
     <?=   $this->Form->end() ?>
        </div>
      </div>
      <div class="col-md-6">
