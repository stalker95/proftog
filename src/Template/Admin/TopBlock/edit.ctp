    ...
    <section class="content">
      <div class="row">
       ...
       <?= $this->Form->create($topBlock,['url'   => array(
               'controller' => 'TopBlock','action' => 'edit'
           ), 'type' => 'file'])  ?>

       <div class="marque__box">
          <p>:Current image </p>
          <?php echo $this->Html->image("/img/home-top-bg/".$topBlock['image'], ['label'=>'true','style'=>'width:100px;height:100px;', 'alt' => __('User Image')]); ?> 
          <br>
          <br>
