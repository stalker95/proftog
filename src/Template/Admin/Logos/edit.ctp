    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
             <h1 class="blog__title"><?=   __('Logo editor '); ?></h1>
          <div class="box">
       ...
       <?= $this->Form->create($logo,['url'   => array(
               'controller' => 'logos','action' => 'edit'
           ), 'type' => 'file'])  ?>

       <div class="marque__box">
          <p>:Current logo </p>
          <?php echo $this->Html->image("logos/".$logo['image'], ['label'=>'true','style'=>'width:150px;display:block;object-fit:cover;', 'alt' => __('User Image')]); ?> 
          <br>
