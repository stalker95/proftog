    ...
    <section class="content">
      <div class="row">
       ...
       <?= $this->Form->create($solution,['url'   => array(
               'controller' => 'Solution','action' => 'edit'
           ), 'type' => 'file'])  ?>

       <div class="marque__box">
          <?=  $this->Form->control('title',array('label' => 'Title','class'=>'form-control','min'=>6));?>
          <p>:Current image </p>
          <?php echo $this->Html->image("/img/home-top-bg/".$solution['image'], ['label'=>'true','style'=>'width:420px;height:250px;object-fit:cover;', 'alt' => __('User Image')]); ?> 
          <br>
          <br>
          ...
          <br>
          <?=  $this->Form->control('link',array('label' => 'Title','class'=>'form-control','min'=>6)); ?>
          <br>
          <?=  $this->Form->control('url',array('label' => 'Url','class'=>'form-control','min'=>6));?>
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                ...
                if ((mimeType != 'image/jpeg') && (mimeType != 'image/jpg') && (mimeType != 'image/png')) {
                    ...
                    dataView = '<div class="thumbnail imgNew" id="imgNew" style="position:relative;width:430px;">';
                    dataView += '<p>:New picture </p>';
                    dataView += '<div id="img-list">';
                    dataView += '<img id="imgMain" class="img-circle" src="' + e.target.result + '" style="width: 150px;border-radius:0px;   object-fit: cover;"/>';
