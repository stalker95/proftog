 ...
 * @method \App\Model\Entity\Advantage newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\Advantage[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\Advantage|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 ...
 * @method \App\Model\Entity\Advantage[] patchEntities($entities, array $data, array $options = [])
...
class AdvantagesTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('svg')
            ->requirePresence('svg', 'create')
            ->allowEmptyString('svg', false);
