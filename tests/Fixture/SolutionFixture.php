 ...
 * SolutionFixture
 */
class SolutionFixture extends TestFixture
{
    /**
     * Table name
     *
    ...
    public $fields = [
        ...
        'link' => ['type' => 'string', 'length' => 1000, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
